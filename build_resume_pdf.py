...
story += [Paragraph("CORE SKILLS", styles["Section"]), Paragraph("Product design · UX/UI design · Information architecture · Workflow design · UX research · Visual design · Cross-team collaboration · Art direction · Game UX", styles["Body"]), Paragraph("SELECTED PROJECT", styles["Section"]), Paragraph("Inventory Management System — Designed and built a user-friendly website from a CSV database to organize inventory records, stock availability, sales, and movement. Structured listing, storage, and fulfillment documentation through a more intuitive inventory interface.", styles["Body"]), Paragraph("EDUCATION", styles["Section"]), Paragraph("Design Management (Post-graduate Certificate) — George Brown College, Toronto, Canada (2022–2023). Dean’s List: Fall 2022 and Winter 2023.", styles["Body"]), Paragraph("Bachelor of Communication (Professional Communications) — RMIT University, Singapore & Australia (2016–2017).", styles["Body"])]
